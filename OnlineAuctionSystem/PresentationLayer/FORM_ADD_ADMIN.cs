...
namespace OnlineAuctionSystem.PresentationLayer
{
    public partial class FORM_ADD_ADMIN : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Create admin object and use add Admin Function
            BussinessLogicLayer.Admin admin = new BussinessLogicLayer.Admin();
            admin.add_Admin(txtUserName.Text,txtPass.Text,txtEmail.Text,txtAddress.Text,txtMobile.Text);
